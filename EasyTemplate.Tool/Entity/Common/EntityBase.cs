...
public abstract class EntityBaseId
{
    ...
    /// Id
    /// </summary>
    [SugarColumn(ColumnDescription = "主键Id", IsIdentity = true, IsPrimaryKey = true)]
...
public abstract class EntityBase : EntityBaseId, IDeletedFilter
{
    ...
    public virtual int? UpdateTimeId { get; set; }
    ...
    [Newtonsoft.Json.JsonIgnore]
    [System.Text.Json.Serialization.JsonIgnore]
    [Navigate(NavigateType.OneToOne, nameof(UpdateTimeId))]
